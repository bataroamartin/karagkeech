...
CUSTOM_FILE_NAME = os.environ.get("CUSTOM_FILE_NAME", "TARUGSKI")
...
GLEECH_UNZIP_COMMAND = os.environ.get("GLEECH_UNZIP_COMMAND", "mirrorunzip")
GLEECH_ZIP_COMMAND = os.environ.get("GLEECH_ZIP_COMMAND", "mirrorzip")
YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "leechwatch")
GYTDL_COMMAND = os.environ.get("GYTDL_COMMAND", "mirrorwatch")
RCLONE_CONFIG = os.environ.get("RCLONE_CONFIG", "")
DESTINATION_FOLDER = os.environ.get("DESTINATION_FOLDER", "TARUGS LEECH")
INDEX_LINK = os.environ.get("INDEX_LINK", "")
TELEGRAM_LEECH_COMMAND = os.environ.get("TELEGRAM_LEECH_COMMAND", "mirrortg")
TELEGRAM_LEECH_UNZIP_COMMAND = os.environ.get(
    "TELEGRAM_LEECH_UNZIP_COMMAND", "unziptg"
)
...
PYTDL_COMMAND = os.environ.get("PYTDL_COMMAND", "leechpytdl")
GPYTDL_COMMAND = os.environ.get("GPYTDL_COMMAND", "mirrorpytdl")
